...
export const dict = {
	...
	'Hide settings icon': {
		...
		pt_BR: 'Ocultar ícone de definições',
	...
	'Customise how and where widgets appear.': {
		...
		pt_BR: 'Personalizar como e onde aparecem os widgets.',
	...
	'to add a list or checkbox': {
		...
		pt_BR: 'para adicionar uma lista ou caixas de verificação',
	...
	'You can now move widgets around, show your own quotes and much more. Take a look at the new features in ': {
		...
		pt_BR: 'Agora você pode mover widgets, mostrar suas próprias citações e muito mais. Dê uma olhada nos novos recursos em  ',
		...
		zh_CN: '您现在可以四处移动小部件，显示您自己的报价等等。 看看中的新功能',
		zh_HK: '您現在可以四處移動小部件，顯示您自己的報價等等。 看看中的新功能',
